...
Relights a depthbake package with a cursor-driven point light. Each pixel's
...
`depthbake-runtime` — bundling just skips that cost.
...
[`bust.depthbake`](./bust.depthbake) is baked from a photo by
